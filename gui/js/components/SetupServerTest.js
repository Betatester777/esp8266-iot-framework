...
import { Form, IconButton, Button, Spinner, TestStatus } from "./UiComponents";
        ...
        return (
            <div>
                ...
                <Form>
                    ...
                    {responseValue}
                    <p>
                        <IconButton name="buttonEdit" icon={<Edit />} onClick={this.props.context.loadPreviousScope} isDisabled={!isSaveEnabled} marginRight={true} />
                        <IconButton name="buttonRepeat" icon={<Repeat />} onClick={this.props.context.load} isDisabled={!isSaveEnabled} marginRight={true} />
